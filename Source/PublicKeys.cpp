...
namespace Sc
{
	static const uint8_t BetaKeyData[160] =
	{
	...
	static const uint8_t PublicKeyData[160] =
	{
		0x30, 0x81, 0x9D, 0x30, 0x0D, 0x06, 0x09, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x01, 
	...
	static const uint8_t InternalKeyData[160] =
	{
		0x30, 0x81, 0x9D, 0x30, 0x0D, 0x06, 0x09, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x01,
	...
	static const std::string BetaKey = std::string((const char *)BetaKeyData, 160);
	static const std::string PublicKey = std::string((const char *)PublicKeyData, 160);
	static const std::string InternalKey = std::string((const char *)InternalKeyData, 160);

	const std::string &GetPublicKey(EUniverse universe)
	{
		static std::string empty = "";

		switch(universe)
		{
		case EUniverse_Beta: return BetaKey;
		case EUniverse_Public: return PublicKey;
		case EUniverse_Internal: return InternalKey;
		}
