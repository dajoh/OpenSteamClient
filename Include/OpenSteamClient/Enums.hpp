#ifndef OPENSTEAMCLIENT_ENUMS_HPP
#define OPENSTEAMCLIENT_ENUMS_HPP
...
namespace Sc
{
	enum EMsg
	{
		...
		EMsg_ClientGamesPlayed_obsolete = 705,
		...
		EMsg_ClientGameConnect_obsolete = 719,
		EMsg_ClientGamesPlayed2_obsolete = 720,
		EMsg_ClientGameEnded_obsolete = 721,
		...
		EMsg_ClientContentServerLogOn_Deprecated = 731,
		...
		EMsg_ClientLogOnWithCredentials_Deprecated = 803,
		...
		EMsg_FBSSetShellCount_obsolete = 1113,
		...
		EMsg_BSQueryGCOrderStatus = 1426,
		EMsg_BSQueryTransactionStatus = 1426,
		EMsg_BSQueryGCOrderStatusResponse = 1427,
		...
		EMsg_BSPurchaseMicroTxn = 1437,
		EMsg_BSPurchaseRunFraudChecks = 1437,
		EMsg_BSPurchaseMicroTxnResponse = 1438,
		...
		EMsg_GCRegisterWebInterfaces = 2217,
		EMsg_GCRegisterWebInterfaces_Deprecated = 2217,
		EMsg_GCGetAccountDetails = 2218,
		EMsg_GCGetAccountDetails_DEPRECATED = 2218,
		...
		EMsg_CCSDeleteAllComments = 3161,
		EMsg_CCSDeleteAllCommentsByAuthor = 3161,
		EMsg_CCSDeleteAllCommentsResponse = 3162,
		...
		EMsg_AMRenewLicenseResponse = 4342,
		...
		EMsg_AMSwapXsollaDeposit = 4348,
		EMsg_AMSwapXsollaDepositResponse = 4349,
		...
		EMsg_ClientAnonUserLogOn_Deprecated = 5409,
		...
		EMsg_ClientLogOnWithHash_Deprecated = 5465,
	...
	enum EChatEntryType
	{
		...
		EChatEntryType_Max = 11
	};

	enum EPersonaState
	{
		EPersonaState_Offline = 0,
	...
	enum EChatPermission
	{
		...
		EChatPermission_EveryoneNotInClanDefault = 8,
		EChatPermission_EveryoneDefault = 10,
		EChatPermission_MemberDefault = 282,
		EChatPermission_OfficerDefault = 282,
		EChatPermission_OwnerDefault = 891,
	...
	{
		EClientPersonaStateFlag_Status = 1,
	...
	enum EAppUsageEvent
	{
		...
		EAppUsageEvent_Max = 9
	};

	enum ELicenseFlags
	{
		ELicenseFlags_None = 0,
	...
	enum EClanRelationship
	{
		...
		EClanRelationship_Max = 6
	};

	enum EAuthSessionResponse
	{
		EAuthSessionResponse_OK = 0,
		...
		EAuthSessionResponse_Max = 9
	};

	enum EChatRoomEnterResponse
	{
		EChatRoomEnterResponse_Success = 1,
		...
		EChatRoomEnterResponse_NoRankingDataLobby = 12,
		EChatRoomEnterResponse_NoRankingDataUser = 13,
		EChatRoomEnterResponse_RankOutOfRange = 14,
		EChatRoomEnterResponse_Max = 15
	};

	enum EChatRoomType
	{
		EChatRoomType_Friend = 1,
		EChatRoomType_MUC = 2,
	...
	enum EChatActionResult
	{
		...
		EChatActionResult_Max = 11
	};

	enum EAppInfoSection
	{
		EAppInfoSection_Unknown = 0,
		...
		EAppInfoSection_ItemsUNUSED = 12,
	...
	enum EServerType
	{
		...
		EServerType_SS = 10,
		EServerType_DRMS = 11,
		EServerType_HubOBSOLETE = 12,
		EServerType_Console = 13,
		EServerType_ASBOBSOLETE = 14,
		EServerType_PICS = 14,
		EServerType_Client = 15,
		EServerType_BootstrapOBSOLETE = 16,
		EServerType_DP = 17,
		EServerType_WG = 18,
		EServerType_SM = 19,
		EServerType_UFS = 21,
		...
		EServerType_P2PRelayOBSOLETE = 25,
	...
	enum EBillingType
	{
		...
		EBillingType_NumBillingTypes = 9,
		EBillingType_Max = 10
	};

	enum EActivationCodeClass
	{
		EActivationCodeClass_WonCDKey = 0,
	...
	{
		EChatMemberStateChange_Entered = 0x01,
	...
	{
		EWorkshopEnumerationType_RankedByVote = 0,
		...
		EWorkshopEnumerationType_Max = 7
	};

	enum EPublishedFileVisibility
	{
		EPublishedFileVisibility_Public = 0,
		EPublishedFileVisibility_FriendsOnly = 1,
		EPublishedFileVisibility_Private = 2,
		EPublishedFileVisibility_Max = 3
	};

	enum EWorkshopFileAction
	{
		EWorkshopFileAction_Played = 0,
		EWorkshopFileAction_Completed = 1,
		EWorkshopFileAction_Max = 2
	};

	enum EEconTradeResponse
	{
		EEconTradeResponse_Accepted = 0,
		EEconTradeResponse_Declined = 1,
		EEconTradeResponse_VacBannedInitiator = 2,
		EEconTradeResponse_TradeBannedInitiator = 2,
		EEconTradeResponse_VacBannedTarget = 3,
		...
		EEconTradeResponse_InitiatorAlreadyTrading = 11,
		EEconTradeResponse_Error = 12,
		EEconTradeResponse_Timeout = 13,
		...
		EEconTradeResponse_Max = 24
	};

	enum EMarketingMessageFlags
	{
		EMarketingMessageFlags_None = 0,
	...
	{
		EDRMBlobDownloadErrorDetail_None = 0,
		...
		EDRMBlobDownloadErrorDetail_Max = 131073
	};

	enum EClientStat
	{
		EClientStat_P2PConnectionsUDP = 0,
